package zju.edu.cn.wechatfood.aspect;
...
//    @Pointcut("execution(public * zju.edu.cn.wechatfood.Controller.Seller*.*(..))" +
//            "&& !execution(public * zju.edu.cn.wechatfood.Controller.SellerUserController.*(..))")
//    public void verify() {
//    }
